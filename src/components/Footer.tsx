...
import { WrenchScrewdriverIcon, PhoneIcon, EnvelopeIcon } from '@heroicons/react/24/outline';
import {
  FaceSmileIcon,
  ChatBubbleOvalLeftEllipsisIcon,
  UserGroupIcon
} from '@heroicons/react/24/solid'; // used for social icons (as placeholders)
