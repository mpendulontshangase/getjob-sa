    ...
    <div className="bg-white py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-extrabold text-blue-600"> GetEmployedSA</h2>
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-700 text-base leading-relaxed">
            GetEmployedSA was founded with a simple mission: to bridge the gap between opportunity and talent. 
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-700 text-base leading-relaxed">
            GetEmployedSA is a job discovery platform that provides real-time job listings, easy application processes, and personalized job alerts. 
